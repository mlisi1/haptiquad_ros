...
from haptiquad_plot.residual_dialogs import SaveDialog
import rospy
...
class ResidualPlotter(PlotterBase):
    ...
    def __init__(self):
        ...
        self.residual_sub = rospy.Subscriber('/residuals', ResidualsStamped, self.callback)
        self.residual_error_sub = rospy.Subscriber('/residual_errors', ResidualErrorStamped, self.errors_callback)
        self.gains_pub = rospy.Publisher('/gains', ObserverGains, queue_size=10)
